package teste.eder.sunshine.climatempo;
...
//        mRef = new Firebase("https://climatempo.firebaseio.com/");
        mRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                String novoClima = (String) dataSnapshot.getValue();
                mTextClima.setText(novoClima);
            }
        ...
        mButtonEnsolarado.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mRef.setValue("Ensolarado");
            }
        });
        ...
        Action viewAction = Action.newAction(
                ...
                Uri.parse("android-app://teste.eder.sunshine.climatempo/http/host/path")
        );
